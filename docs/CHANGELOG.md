...
### Added
- Clickable links in the generated PDF resume for GitHub, LinkedIn, and email addresses, enhancing the interactivity and accessibility of the resume.

### Fixed
- Improve `~` rendering on the resume.

## [0.1.7] - 2026-08-13

### Added
- Emphasis on numerical metrics in bullet generation, including counts, percentages, and time durations, to enhance the impact of resume entries.
- Added notes on metrics in the status page, this reminds users of missed opportunities to include metrics in their resume entries and encourages them to add relevant numerical data for stronger bullet points.
...
### Fixed
- Revert project selection default count to unlimited, allowing maximum project coverage for bullet generation and resume output.
