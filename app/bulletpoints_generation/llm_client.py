...
def build_bulletpoint_instructions(
    ...
    return (
        ...
        "guessing. Treat the evidence as raw factual notes. Rewrite it into concise "
        "accomplishment statements; do not copy the evidence wording, structure, or "
        "tone. Each bullet must start with a strong action verb and follow this "
        "structure: action + purpose/context + method/tool + supported impact. Target "
        "18 to 26 words and never exceed 32 words. Express one main accomplishment "
        "only. Use metrics only when the evidence supports them; otherwise use a "
        ...
        "lead with the highest-value contribution for the role. Use present-tense "
        "verbs for active/current work and past-tense verbs for completed work when "
        "the evidence makes timing clear. Avoid repeating duties; focus on "
        "contributions, decisions, and outcomes. Do not use leading bullet markers. "
